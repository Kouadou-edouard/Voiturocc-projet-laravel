...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/js/bootstrap.bundle.min.js" integrity="sha384-ENjdO4Dr2bkBIFxQpeoTz1HIcje39Wm4jDKdf19U8gI4ddQ3GYNS7NTKfAdVQSZe" crossorigin="anonymous"></script>
        ...
        <div class="login-form">
            ...
            <form action="{{route ('registration')}}" method="post">
                ...
                <br>
                <div class="form-group">
                    <input type="text" name="username" class="form-control" placeholder="Nom utilisateur" value={{old('username')}}>
                    @error('username')
                    <div class="text text-alert">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <center>
                <div class="form-group">
                    <button type="submit" class="btn btn-primary btn-block" style="background-color: gray;">S'inscrire</button>
                </div> 
            </center>  
            </form>
            <center>
            <p>Déjà un compte? <a href="{{ route('connexion') }}" style="color: white;">Connectez-vous</a></p>
            </center>
        </div>
        <!-- Formulaire -->
